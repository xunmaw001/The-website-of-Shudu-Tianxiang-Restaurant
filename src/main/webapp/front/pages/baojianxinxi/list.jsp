          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="bjname" id="bjname" placeholder="包间名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('baojianxinxi','新增')" @click="jump('../baojianxinxi/add.jsp')" type="button" class="layui-btn btn-theme">
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../baojianxinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.imgPhoto?item.imgPhoto.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.bjname}}</h5>
                  <p v-if="item.money">{{item.money}} RMB</p>
                </div>
              </a>
            </li>
          </ul>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#bjname').val()) {
          param['bjname'] = jquery('#bjname').val() ?jquery('#bjname').val(): '';
        }  

        // 获取列表数据
        http.request('baojianxinxi/page', 'get', param, function(res) {
