			...
			<form class="layui-form" lay-filter="myForm">
				<div class="layui-form-item" style="margin: 20px;background: #FFFFFF;border:3px dotted #EEEEEE;padding: 20px;">
					...
					<div class="layui-input-block">
						<input type="number" name="remaining" id="remaining" required lay-verify="required" placeholder="充值金额" autocomplete="off"
						 class="layui-input">
					</div>
				</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'http', 'jquery', 'form'], function() {
				...
				form.on('submit(*)', function(data) {
					// 添加金额
					data = data.field;
					vue.user.remaining = Number(vue.user.remaining) + Number(data.remaining);
