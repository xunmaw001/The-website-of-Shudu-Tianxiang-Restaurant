          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="cpname" id="cpname" placeholder="菜品名称" autocomplete="off" class="layui-input">
              </div>
            </div>
        ...
        <div class="pro-lists-con">
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../caipinxinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#cpname').val()) {
          param['cpname'] = jquery('#cpname').val()?jquery('#cpname').val() : '';
        }  
        if (jquery('#lxTypes').val()) {
          param['lxTypes'] = jquery('#lxTypes').val()?jquery('#lxTypes').val() : '';
        }

        // 获取列表数据
        http.request('caipinxinxi/page', 'get', param, function(res) {
