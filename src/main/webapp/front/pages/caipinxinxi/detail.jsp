...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(
            `leixing/page`, 'get', {}, function (res) {
                if (res && res.code === 0) {
                    this.lxTypesSelectSearch = res.data.list;
                } else {
        ...
        http.request(`${vue.detailTable}/info/` + id, 'get', {}, function (res) {
            ...
            var lxTypesSelect = this.lxTypesSelectSearch;
            for (var i = 0; i < lxTypesSelect.length; i++) {
                if(lxTypesSelect[i].id == vue.detail.lxTypes){
                    vue.detail.lxTypes = lxTypesSelect[i].lxname;
                }
            }
