...
<body>
    ...
    <div class="plate">
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          <div class="comm-title">
            <div class="title">
              <h3>店面介绍</h3>
              <p>Store to introduce</p>
            </div>
          </div>
          <div class="picture-lists">
                <h2 id="bt">{{zhutixinxiRecommend}}</h2>
          </div>
        </div>
      </div>
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in caipinxinxiRecommend" v-bind:key="index">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`caipinxinxi/page`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
      ...
      http.request(`zhutixinxi/page`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.zhutixinxiRecommend = res.data.list[0].noticeContent;
      });
