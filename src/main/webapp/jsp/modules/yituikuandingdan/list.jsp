								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('goodid')">菜品id<i id="goodidIcon" class="fa fa-sort"></i>
											</th>
											<th onclick="sort('goodname')">菜品名称<i id="goodnameIcon"
													class="fa fa-sort"></i></th>
											<th onclick="sort('picture')">菜品图片<i id="pictureIcon"
													class="fa fa-sort"></i></th>
