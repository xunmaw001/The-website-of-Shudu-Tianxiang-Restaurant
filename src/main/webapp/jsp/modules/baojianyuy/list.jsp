    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">包间预约表管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">包间预约表列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">包间预约表列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                                                                                 
                                        <label>
                                            <input type="text" id="bjnameSearch" class="form-control form-control-sm"
                                                   placeholder="包间名称" aria-controls="tableId">
                                        </label>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('bjnumber')">包间编号</th>
                                    <th onclick="sort('bjname')">包间名称</th>
                                    <th>图片</th>
                                    <th onclick="sort('money')">包间定金</th>
                                    <th onclick="sort('yhTypes')">预约用户</th>
                                    <th onclick="sort('noticeTime')">预约时间</th>
...
<script>
    ...
    function search() {
        ...
        if ($('#bjnameSearch').val() != null && $('bjnameSearch').val() != '') {
            searchForm.bjname = $('#bjnameSearch').val();
    ...
    function getDataList() {
        http("baojianyuy/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
                    bjname: searchForm.bjname,
    }, (res) => {
            if(res.code == 0
            )
            {
    ...
    function setDataRow(item, number) {
        ...
        var bjnumberCell = document.createElement('td');
        bjnumberCell.innerHTML = item.bjnumber;
        row.appendChild(bjnumberCell);
        var bjnameCell = document.createElement('td');
        bjnameCell.innerHTML = item.bjname;
        row.appendChild(bjnameCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("baojianyuy/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "baojianyuy");
