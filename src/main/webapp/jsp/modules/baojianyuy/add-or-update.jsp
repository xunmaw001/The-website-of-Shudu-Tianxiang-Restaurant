    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑包间预约表</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">包间预约表管理</li>
                        <li class="breadcrumb-item active">编辑包间预约表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">包间预约表信息</h3>
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    <input id="updateId" name="id" type="hidden">
                                <div class="form-group col-md-6">
                                    <label>包间编号</label>
                                    <input id="bjnumber" name="bjnumber" class="form-control"
                                           onchange="bjnumberChickValue(this)"  placeholder="包间编号" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>包间名称</label>
                                        <input id="bjname" name="bjname" class="form-control"
                                               placeholder="包间名称" readonly>
                                    </div>
                                   <div class="form-group col-md-6">
                                       <label>图片</label>
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="money" name="money" class="form-control"
                                            onchange="moneyChickValue(this)" placeholder="包间定金" readonly>
                                 </div>
                                   <div class="form-group col-md-6">
                                       <label>预约用户</label>
                                       <input id="yhTypesSelect" name="yhTypesSelect" class="form-control" placeholder="预约用户" readonly>
                                       </select>
                                   </div>
                                    <div class="form-group col-md-6">
                                        <label>预约时间</label>
                                        <input id="noticeTime" name="noticeTime" class="form-control" placeholder="预约时间" type="date">
                                        </select>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "baojianyuy/info/" + id,
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("baojianyuy/" + urlParam, "POST", data, (res) => {
                if(res.code == 0
        )
            {
    ...
    function getDetails() {
        ...
        if (id != null && id != "" && id != "null") {
            updateId = id;
            window.sessionStorage.removeItem('updateId');
            http("baojianyuy/info/" + id, "GET", {}, (res) => {
                if(res.code == 0
        )
            {
                ruleForm = res.data
    ...
    function dataBind() {
        ...
        $("#bjnumber").val(ruleForm.bjnumber);
        $("#bjname").val(ruleForm.bjname);
        $("#noticeTime").val(ruleForm.noticeTime);
        $("#money").val(ruleForm.money);
        for(var i = 0; i<yhTypesOptions.length; i++){
            if(yhTypesOptions[i].id == ruleForm.yhTypes){
                $("#yhTypesSelect").val(yhTypesOptions[i].name);
            }
        }
