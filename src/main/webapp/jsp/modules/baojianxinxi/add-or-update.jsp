    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑包间信息表</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑包间信息表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">包间信息表信息</h3>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="bjnumber" name="bjnumber" class="form-control"
                                           onchange="bjnumberChickValue(this)"  placeholder="包间编号">
                                </div>
                                 ...
                                 <div class="form-group col-md-6">
                                     ...
                                     <input id="money" name="money" class="form-control"
                                            onchange="moneyChickValue(this)" placeholder="包间定金">
                                 </div>
