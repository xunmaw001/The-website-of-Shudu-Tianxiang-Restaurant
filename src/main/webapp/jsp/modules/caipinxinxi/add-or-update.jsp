                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>菜品名称</label>
                                        <input id="cpname" name="cpname" class="form-control"
                                               placeholder="菜品名称">
                                    </div>
                                   <div class="form-group col-md-6">
                                       <label>类型</label>
    ...
    function initializationLxtypesSelect(){
        var lxTypesSelect = document.getElementById('lxTypesSelect');
            for (var i = 0; i < lxTypesOptions.length; i++) {
                lxTypesSelect.add(new Option(lxTypesOptions[i].lxname,lxTypesOptions[i].id));
            }
    }
    // 下拉框选项回显
    function setSelectOption() {
        for (var i = 0; i < lxTypesOptions.length; i++) {
            if(lxTypesOptions[i].id == ruleForm.lxTypes){//下拉框value对比,如果一致就赋值汉字
