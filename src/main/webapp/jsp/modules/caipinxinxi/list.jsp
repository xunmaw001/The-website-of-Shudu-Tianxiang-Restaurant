                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            <input type="text" id="cpnameSearch" class="form-control form-control-sm"
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('cpname')">菜品名称</th>
                                    <th onclick="sort('lxTypes')">类型</th>
                                    <th>图片</th>
...
<script>
    ...
    function search() {
        ...
        if ($('#cpnameSearch').val() != null && $('cpnameSearch').val() != '') {
            searchForm.cpname = $('#cpnameSearch').val();

        }
     
        var lxTypesIndex = document.getElementById("lxTypesSelectSearch").selectedIndex;
        var lxTypesValue;
        if( lxTypesIndex  == 0){
                lxTypesValue='';
        }else{
                lxTypesValue= document.getElementById("lxTypesSelectSearch").options[lxTypesIndex].value;
        }

        searchForm.lxTypes = lxTypesValue;
    ...
    function setDataRow(item, number) {
        ...
        var cpnameCell = document.createElement('td');
        cpnameCell.innerHTML = item.cpname;
        row.appendChild(cpnameCell);

        var lxTypesCell = document.createElement('td');
        for (var i = 0; i < lxTypesOptions.length; i++) {
            if(lxTypesOptions[i].id == item.lxTypes){//下拉框value对比,如果一致就赋值汉字
                    lxTypesCell.innerHTML = lxTypesOptions[i].lxname;
            }
        }
    ...
    //填充搜索下拉框
            ...
            function lxTypesSelectSearch() {
                ...
                for (var i = 0; i < lxTypesOptions.length; i++) {
                        lxTypesSelectSearch.add(new Option(lxTypesOptions[i].lxname,lxTypesOptions[i].id));
                }
            }
    ...
    //查询当前页面下所有列表
        function lxTypesSelect() {
            //填充下拉框选项
            http("leixing/page?page=1&limit=100&sort=&order=&dicCode=lx_types", "GET", {}, (res) => {
                if(res.code == 0){
